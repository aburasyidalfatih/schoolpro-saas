    ...
    <div className="space-y-6 max-w-3xl">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground mt-1">Tambahkan dokumen baru ke pusat unduhan.</p>
        </div>
      </div>
      ...
      <Card className="glass border-0">
        <form onSubmit={handleSubmit}>
          ...
          <div className="px-6 py-4 border-t bg-muted/10 flex justify-end gap-3 rounded-b-xl">
            ...
            <Button type="submit" className="gap-2 btn-gradient text-white border-0 rounded-xl" disabled={saving || !file || !formData.title}>
              {saving ? (
                <>
